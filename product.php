    ...
    <div class="container">
        <div class="d-flex align-items-start flex-lg-row flex-column">
            <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                <h2>Our Products</h2>
                <button class="nav-link active" id="v-pills-one-tab" data-bs-toggle="pill" data-bs-target="#v-pills-one" type="button" role="tab" aria-controls="v-pills-one" aria-selected="true">Discrete semiconductors</button>
                <button class="nav-link" id="v-pills-two-tab" data-bs-toggle="pill" data-bs-target="#v-pills-two" type="button" role="tab" aria-controls="v-pills-two" aria-selected="false">Embedded Processors &
                    Controllers</button>
                <button class="nav-link" id="v-pills-three-tab" data-bs-toggle="pill" data-bs-target="#v-pills-three" type="button" role="tab" aria-controls="v-pills-three" aria-selected="false">Integrated Circuits - ICs</button>
                <!-- <button class="nav-link" id="v-pills-four-tab" data-bs-toggle="pill" data-bs-target="#v-pills-four" type="button" role="tab" aria-controls="v-pills-four" aria-selected="false">Memory ICs</button>
                <button class="nav-link" id="v-pills-five-tab" data-bs-toggle="pill" data-bs-target="#v-pills-five" type="button" role="tab" aria-controls="v-pills-five" aria-selected="false">Wireless & RF
                    Semiconductors</button> -->
                <button class="nav-link" id="v-pills-six-tab" data-bs-toggle="pill" data-bs-target="#v-pills-six" type="button" role="tab" aria-controls="v-pills-six" aria-selected="false">Passive Components</button>

                <!-- <button class="nav-link" id="v-pills-eight-tab" data-bs-toggle="pill" data-bs-target="#v-pills-eight" type="button" role="tab" aria-controls="v-pills-eight" aria-selected="false">IGBT module</button>
                <button class="nav-link" id="v-pills-nine-tab" data-bs-toggle="pill" data-bs-target="#v-pills-nine" type="button" role="tab" aria-controls="v-pills-nine" aria-selected="false">Mitsubishi Servo
                    Motor</button> -->
                <button class="nav-link" id="v-pills-ten-tab" data-bs-toggle="pill" data-bs-target="#v-pills-ten" type="button" role="tab" aria-controls="v-pills-ten" aria-selected="false">Relays</button>
                <button class="nav-link" id="v-pills-seven-tab" data-bs-toggle="pill" data-bs-target="#v-pills-seven" type="button" role="tab" aria-controls="v-pills-seven" aria-selected="false">Connectors</button>
                <!-- <button class="nav-link" id="v-pills-eleven-tab" data-bs-toggle="pill" data-bs-target="#v-pills-eleven" type="button" role="tab" aria-controls="v-pills-eleven" aria-selected="false">Contactors</button>
                <button class="nav-link" id="v-pills-twelve-tab" data-bs-toggle="pill" data-bs-target="#v-pills-twelve" type="button" role="tab" aria-controls="v-pills-twelve" aria-selected="false">PIc module</button>
                <button class="nav-link" id="v-pills-thirteen-tab" data-bs-toggle="pill" data-bs-target="#v-pills-thirteen" type="button" role="tab" aria-controls="v-pills-thirteen" aria-selected="false">Controller</button>
                <button class="nav-link" id="v-pills-fourteen-tab" data-bs-toggle="pill" data-bs-target="#v-pills-fourteen" type="button" role="tab" aria-controls="v-pills-fourteen" aria-selected="false">Cooling fan</button>
                <button class="nav-link" id="v-pills-fifteen-tab" data-bs-toggle="pill" data-bs-target="#v-pills-fifteen" type="button" role="tab" aria-controls="v-pills-fifteen" aria-selected="false">Blower & ventilator fans</button>
                <button class="nav-link" id="v-pills-sixteen-tab" data-bs-toggle="pill" data-bs-target="#v-pills-sixteen" type="button" role="tab" aria-controls="v-pills-sixteen" aria-selected="false">Sensors</button> -->
            </div>
            ...
            <div class="tab-content ps-lg-5 px-3 pt-3" id="v-pills-tabContent">

                <div class="tab-pane fade show active" id="v-pills-one" role="tabpanel" aria-labelledby="v-pills-one-tab">
                    <h3 class="fw-semibold mb-3">Diode & Rectifiers</h3>
                    <div class="row mb-5">
                        <div class="col-md-6">
                            <div class="card">
                        ...
                        <!-- <div class="col-md-6">
                            <div class="card">
                                <img src="main-products/Diode & Rectfiers.jpg">
                                <h5 class="fw-bold"><a href="#!" class="text-dark text-decoration-none">Diode & Rectifiers </a></h5><button type="button" class="btn mb-3 mt-2 mx-auto pd--btn" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                    Contact  Us
                                </button>
                            </div>
                        </div> -->
                    </div>
                    <h3 class="fw-semibold mb-3">Transistors</h3>
                    <div class="row mb-5">
                        <div class="col-md-6">
                            <div class="card">
                    ...
                    <h3 class="fw-semibold mb-3">Thyristors</h3>
                    <div class="row mb-5">
                        <div class="col-md-6">
                            <div class="card">
                ...
                <div class="tab-pane fade" id="v-pills-two" role="tabpanel" aria-labelledby="v-pills-two-tab">
                    ...
                    <h3 class="fw-semibold mb-3">Processors</h3>
                    <div class="row mb-5">
                        <div class="col-md-6">
                            <div class="card">
                    ...
                    <h3 class="fw-semibold mb-3">Controllers</h3>
                    <div class="row mb-5">
                        <div class="col-md-6">
                            <div class="card">
                ...
                <div class="tab-pane fade" id="v-pills-three" role="tabpanel" aria-labelledby="v-pills-three-tab">
                    ...
                    <h3 class="fw-semibold mb-3">Integrated Circuits</h3>
                    <div class="row mb-5">
                ...
                <!-- <div class="tab-pane fade" id="v-pills-four" role="tabpanel" aria-labelledby="v-pills-four-tab">
                    <h3 class="fw-semibold mb-3">Memory ICs</h3>
                    <div class="row mb-5">
                        <div class="col-md-6">
                            <div class="card">
                                <img src="main-products/Memory ICs.webp">
                                <h5 class="fw-bold"><a href="#!" class="text-dark text-decoration-none">Memory ICs</a></h5><button type="button" class="btn mb-3 mt-2 mx-auto pd--btn" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                    Contact  Us
                                </button>
                ...
                <div class="tab-pane fade" id="v-pills-six" role="tabpanel" aria-labelledby="v-pills-six-tab">
                    ...
                    <h3 class="fw-semibold mb-3">Capacitors</h3>
                    <div class="row mb-5">
                        <div class="col-md-6">
                            <div class="card">
                    ...
                    <h3 class="fw-semibold mb-3">Inductors</h3>
                    <div class="row mb-5">
                        <div class="col-md-6">
                            <div class="card">
                    ...
                    <h3 class="fw-semibold mb-3"> Frequency Control & Timing Devices</h3>
                    <div class="row mb-5">
                        <div class="col-md-6">
                            <div class="card">
                    ...
                    <h3 class="fw-semibold mb-3">Resistors</h3>
                    <div class="row mb-5">
                        <div class="col-md-6">
                            <div class="card">
                ...
                <div class="tab-pane fade" id="v-pills-ten" role="tabpanel" aria-labelledby="v-pills-ten-tab">
                    ...
                    <h3 class="fw-semibold mb-3">Industrial Relays</h3>
                    <div class="row mb-5">
                        <div class="col-md-6">
                            <div class="card">
                ...
                <div class="tab-pane fade" id="v-pills-seven" role="tabpanel" aria-labelledby="v-pills-seven-tab">
                    <h3 class="fw-semibold mb-3">Automotive Connectors</h3>
                    <div class="row mb-5">
                        <div class="col-md-6">
                            <div class="card">
                    ...
                    <h3 class="fw-semibold mb-3">Circular Connector</h3>
                    <div class="row mb-5">
                        <div class="col-md-6">
                            <div class="card">
                    ...
                    <h3 class="fw-semibold mb-3">D-Sub Connectors</h3>
                    <div class="row mb-5">
                        <div class="col-md-6">
                            <div class="card">
                    ...
                    <h3 class="fw-semibold mb-3">Terminal Blocks</h3>
                    <div class="row mb-5">
                        <div class="col-md-6">
                            <div class="card">
                    ...
                    <h3 class="fw-semibold mb-3">Power Connectors</h3>
                    <div class="row mb-5">
                        <div class="col-md-6">
                            <div class="card">
                ...
                <div class="tab-pane fade" id="v-pills-thirteen" role="tabpanel" aria-labelledby="v-pills-thirteen-tab">
                    Controller
                </div>
                <div class="tab-pane fade" id="v-pills-fourteen" role="tabpanel" aria-labelledby="v-pills-fourteen-tab">
                    Cooling fan
                </div>
                <div class="tab-pane fade" id="v-pills-fifteen" role="tabpanel" aria-labelledby="v-pills-fifteen-tab">
                    Blower & ventilator fans
                </div>
                <div class="tab-pane fade" id="v-pills-sixteen" role="tabpanel" aria-labelledby="v-pills-sixteen-tab">
                    Sensors
                </div>
            </div>
        </div>
