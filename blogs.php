...
<section id="blogs-container">
    <div class="container  mx-auto  py-4">
        ...
        <h3 class="fw-bold text-center mb-5">Industry Trends & Insight</h3>
        <div class="row">
    ...
    <div class="container  mx-auto  py-4">
        ...
        <h3 class="fw-bold text-center mb-5">Manufacturer news</h3>
        <div class="row">
            <div class=" col-lg-4 col-md-4 col-sm-6 col-12 my-4">
                <div class="blog-card">
                    <div class="blog-img"><img width="100%" height="100%" src="bg/blog-1.jpg" alt=""></div>
    ...
    <div class="container  mx-auto  py-4">
        ...
        <h3 class="fw-bold text-center mb-5">Events</h3>
        <div class="row">
            <div class=" col-lg-4 col-md-4 col-sm-6 col-12 my-4">
                <div class="blog-card">
                    <div class="blog-img"><img width="100%" height="100%" src="bg/blog-1.jpg" alt=""></div>
    ...
    <div class="container  mx-auto  py-4">
        ...
        <h3 class="fw-bold text-center mb-5">Exhibitions</h3>
        <div class="row">
            <div class=" col-lg-4 col-md-4 col-sm-6 col-12 my-4">
                <div class="blog-card">
                    <div class="blog-img"><img width="100%" height="100%" src="bg/blog-1.jpg" alt=""></div>
